...
The triangles in the background are the longer time line (years, moons, etc), 
while the triangles in the foreground are shorter time elements.*/
...
function draw() {
  ...
  // Back row (1-5) consist of longer times
  // Tooth 1
  fill('#4B0082');
  ...
  // Front Row (6-9) consist of shorter times
  // Tooth 6
  fill('#800080');
  triangle(50, 0, 150, 0, 100, toothLengthD);
  //Tooth 7
  fill('#9400D3');
  triangle(150, 0, 250, 0, 200, toothLengthHD);
  //Tooth 8
  fill('#8A2BE2');
  triangle(250, 0, 350, 0, 300, toothLengthH);
  //Tooth 9
  fill('#BA55D3');
  triangle(350, 0, 450, 0, 400, toothLengthMin);
}